      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  ...
                  files: [
                    '/assets/js/vendor/modules/angular-file-upload/angular-file-upload.min.js'
                  ]
              },
              {
                  name:'ui.calendar',
                  files: ['/assets/js/vendor/modules/angular-ui-calendar/calendar.js']
              },
              {
                  name: 'ngImgCrop',
                  files: [
              ...
              },
              {
                  ...
                  files: [
                      '/assets/js/vendor/modules/angular-bootstrap-nav-tree/abn_tree_directive.js',
                      '/assets/js/vendor/modules/angular-bootstrap-nav-tree/abn_tree.css'
                  ]
              },
              {
                  name: 'toaster',
